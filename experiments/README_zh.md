...
| [DeepSeek 架构演进公平实验](06_architecture_evolution_plan_zh.md) | 代码完成，待上卡 | 普通/细粒度/shared MoE、aux 权重、aux/bias、朴素低秩 KV、GQA/MLA、MTP 的实验驱动决策链 |
...
| 教程深度 | 已有四代完整模型和相邻版本代码课 | 用新 GPU 数据回填 V3 消融结论 |
